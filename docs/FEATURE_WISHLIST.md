...
*Last updated: 2026-04-10. Earnings avoidance (PR #74), agent restart policy (PR #75) done. Next: alert on stop cancelled without fill, max daily loss limit, Redis backup.*
