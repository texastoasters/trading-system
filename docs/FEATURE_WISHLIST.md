...
*Last updated: 2026-04-10. Cancelled stop resubmit + daily loss CB fixes (PR #81) done. Next: automated Redis backup, graceful shutdown, per-instrument P&L breakdown.*
